...
import KaliToolsPage from "./components/KaliToolsPage";
        ...
        {activeNav === "investigate" ? (
          <>
            <div className="flex items-center gap-3 px-6 py-3 border-b border-gray-800 bg-gray-950 shrink-0">
              ...
              <div>
                <h1 className="text-base font-semibold text-gray-100">Kali Linux Tools Library</h1>
                <p className="text-xs text-gray-500 mt-0.5">130+ security tools across 13 categories</p>
              </div>
            </div>
            <KaliToolsPage />
          </>
